    ...
    <nav className="bg-white py-4 px-8 shadow-sm">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center space-x-8">
          ...
          <Link href="/dashboard" className="text-gray-700 hover:text-red-500">
            Dashboard
          </Link>
          <Link href="/report" className="text-gray-700 hover:text-red-500">
            Report
          </Link>
          <Link href="/contacts" className="text-gray-700 hover:text-red-500">
            Contacts
          </Link>
          <Link 
            href="/login" 
            className="px-6 py-2 bg-white text-gray-700 rounded shadow-md hover:shadow-lg transition-shadow"
          >
            Login
          </Link>
        </div>
